package com.github.tix320.skimp.internal.check;
...
public final class Failure<T> implements Try<T> {
	...
	@Override
	public <X extends Exception> Optional<T> optionalOrElseThrow(CheckedSupplier<? extends X> exSupplier) throws X {
	...
	@Override
	public <X extends Exception> Optional<T> optionalOrElseThrow(
			CheckedFunction<Exception, ? extends X> exMapper) throws X {
		Objects.requireNonNull(exMapper, "Mapper cannot be null");
