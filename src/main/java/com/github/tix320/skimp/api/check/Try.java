package com.github.tix320.skimp.api.check;
...
import com.github.tix320.skimp.api.function.*;
import com.github.tix320.skimp.api.object.None;
import com.github.tix320.skimp.internal.check.Failure;
import com.github.tix320.skimp.internal.check.Success;
...
public interface Try<T> {
	...
	<X extends Exception> Optional<T> optionalOrElseThrow(CheckedSupplier<? extends X> exSupplier) throws X;

	<X extends Exception> Optional<T> optionalOrElseThrow(CheckedFunction<Exception, ? extends X> exMapper) throws X;

	T getOrElse(T value);

	T getOrElse(Supplier<T> valueSupplier);

	<X extends Exception> T getOrElseThrow(CheckedSupplier<? extends X> exSupplier) throws X;

	<X extends Exception> T getOrElseThrow(CheckedFunction<Exception, ? extends X> exMapper) throws X;
