...
public final class TracerExecutorService implements ExecutorService {

	private final ExecutorService executorService;

	private TracerExecutorService(ExecutorService executorService) {
		this.executorService = executorService;
	}

	public static ExecutorService wrap(ExecutorService executorService) {
		if (AssertionUtils.isEnabled()) {
			return new TracerExecutorService(executorService);
		}
		else {
